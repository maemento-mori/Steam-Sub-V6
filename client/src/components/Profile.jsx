...
const Profile = ({ userData, profileData }) => {
  ...
  return (
    ...
    {showProfile && 
    (
      <div className="header-info-holder" style={(showStyle) ? {backgroundImage: `url("${profileData.profileBG}")`} : {background: "#fff"}}>
          ...
          <ul className="player-info">
            <li>
              ...
              <div className={`friendPlayerLevel ${profileData.playerLevelClass}`}>
                  {profileData.playerLevel ? <span className="friendPlayerLevelNum">{profileData?.playerLevel} </span> : ""}
              </div>
            </li>
            <li>
            ...
            <li>
              <button className="friendPlayerProfileLink">Go to Profile</button>
            </li>
          </ul>
        </div>
        <div className="favorite_badge">
          ...
          <div className="favorite_badge_description">
            <div className="name">
              {profileData.favBadgeName}
            </div>
            <div className="xp">
              {profileData.favBadgeXP}
            </div>
          </div>
